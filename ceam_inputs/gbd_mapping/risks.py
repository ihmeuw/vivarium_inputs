"""Mapping of GBD risk entities.

This code is automatically generated by /ceam_inputs/gbd_mapping/scripts/risk_builder.py
Any manual changes will be lost.
"""
from .templates import (Risk, Risks, Levels, Tmred, ExposureParameters, Restrictions,
                        rid, scalar, UNKNOWN)
...
risk_factors = Risks(
    ...
    child_wasting=Risk(
        ...
        affected_causes=(causes.diarrheal_diseases, ), #causes.lower_respiratory_infections, causes.measles, causes.protein_energy_malnutrition, ),
    ),
    child_stunting=Risk(
        name='child_stunting',
        gbd_id=rid(241),
