"""This code is automatically generated by /ceam_inputs/gbd_mapping/scripts/template_builder.py
...
class Risk(GbdRecord):
    """Container for risk factor GBD ids and metadata."""
...
class Causes(GbdRecord):
    ...
    __slots__ = ('all_causes', 'hiv_aids_resulting_in_other_diseases', 'diarrheal_diseases', 'typhoid_fever',
                 'paratyphoid_fever', 'other_intestinal_infectious_diseases', 'lower_respiratory_infections',
                 'upper_respiratory_infections', 'otitis_media', 'pneumococcal_meningitis',
                 'h_influenzae_type_b_meningitis', 'meningococcal_meningitis', 'other_meningitis', 'encephalitis',
                 'diphtheria', 'whooping_cough', 'tetanus', 'measles', 'varicella_and_herpes_zoster', 'malaria',
                 'chagas_disease', 'visceral_leishmaniasis', 'cutaneous_and_mucocutaneous_leishmaniasis',
                 'african_trypanosomiasis', 'schistosomiasis', 'cysticercosis', 'cystic_echinococcosis',
                 'lymphatic_filariasis', 'onchocerciasis', 'trachoma', 'dengue', 'yellow_fever', 'rabies',
                 'ascariasis', 'trichuriasis', 'hookworm_disease', 'food_borne_trematodiases',
                 'other_neglected_tropical_diseases', 'maternal_hemorrhage',
                 ...
                 'maternal_abortion_miscarriage_and_ectopic_pregnancy', 'indirect_maternal_deaths',
                 'late_maternal_deaths', 'other_maternal_disorders', 'neonatal_preterm_birth_complications',
                 ...
                 'other_neonatal_disorders', 'protein_energy_malnutrition', 'iodine_deficiency',
                 'vitamin_a_deficiency', 'iron_deficiency_anemia', 'other_nutritional_deficiencies', 'syphilis',
                 'chlamydial_infection', 'gonococcal_infection', 'trichomoniasis', 'genital_herpes',
                 'other_sexually_transmitted_diseases', 'acute_hepatitis_a', 'hepatitis_b', 'hepatitis_c',
                 'acute_hepatitis_e', 'leprosy', 'other_infectious_diseases', 'esophageal_cancer', 'stomach_cancer',
                 'liver_cancer_due_to_hepatitis_b', 'liver_cancer_due_to_hepatitis_c',
                 'liver_cancer_due_to_alcohol_use', 'liver_cancer_due_to_other_causes', 'larynx_cancer',
                 ...
                 'malignant_skin_melanoma', 'ovarian_cancer', 'testicular_cancer', 'kidney_cancer', 'bladder_cancer',
                 'brain_and_nervous_system_cancer', 'thyroid_cancer', 'mesothelioma', 'hodgkin_lymphoma',
                 'non_hodgkin_lymphoma', 'multiple_myeloma', 'other_neoplasms', 'rheumatic_heart_disease',
                 'ischemic_heart_disease', 'ischemic_stroke', 'hemorrhagic_stroke', 'hypertensive_heart_disease',
                 'atrial_fibrillation_and_flutter', 'aortic_aneurysm', 'peripheral_artery_disease', 'endocarditis',
                 'other_cardiovascular_and_circulatory_diseases', 'chronic_obstructive_pulmonary_disease',
                 ...
                 'other_digestive_diseases', 'alzheimer_disease_and_other_dementias', 'parkinson_disease',
                 'epilepsy', 'multiple_sclerosis', 'migraine', 'tension_type_headache', 'motor_neuron_disease',
                 'other_neurological_disorders', 'schizophrenia', 'alcohol_use_disorders', 'opioid_use_disorders',
                 'cocaine_use_disorders', 'amphetamine_use_disorders', 'cannabis_use_disorders',
                 'other_drug_use_disorders', 'major_depressive_disorder', 'dysthymia', 'bipolar_disorder',
                 'anxiety_disorders', 'anorexia_nervosa', 'bulimia_nervosa', 'autism',
                 'asperger_syndrome_and_other_autistic_spectrum_disorders',
                 'attention_deficit_hyperactivity_disorder', 'conduct_disorder',
                 'idiopathic_developmental_intellectual_disability', 'other_mental_and_substance_use_disorders',
                 'diabetes_mellitus', 'acute_glomerulonephritis', 'chronic_kidney_disease_due_to_diabetes_mellitus',
                 'chronic_kidney_disease_due_to_hypertension', 'chronic_kidney_disease_due_to_glomerulonephritis',
                 'chronic_kidney_disease_due_to_other_causes', 'interstitial_nephritis_and_urinary_tract_infections',
                 'urolithiasis', 'benign_prostatic_hyperplasia', 'male_infertility', 'other_urinary_diseases',
                 'uterine_fibroids', 'polycystic_ovarian_syndrome', 'female_infertility', 'endometriosis',
                 'genital_prolapse', 'premenstrual_syndrome', 'other_gynecological_diseases', 'thalassemias',
                 'sickle_cell_disorders', 'g6pd_deficiency', 'other_hemoglobinopathies_and_hemolytic_anemias',
                 'endocrine_metabolic_blood_and_immune_disorders', 'rheumatoid_arthritis', 'osteoarthritis',
                 'low_back_pain', 'neck_pain', 'gout', 'other_musculoskeletal_disorders', 'neural_tube_defects',
                 'congenital_heart_anomalies', 'orofacial_clefts', 'down_syndrome', 'turner_syndrome',
                 'klinefelter_syndrome', 'other_chromosomal_abnormalities',
                 'congenital_musculoskeletal_and_limb_anomalies', 'urogenital_congenital_anomalies',
                 'digestive_congenital_anomalies', 'other_congenital_birth_defects', 'dermatitis', 'psoriasis',
                 'cellulitis', 'pyoderma', 'scabies', 'fungal_skin_diseases', 'viral_skin_diseases', 'acne_vulgaris',
                 'alopecia_areata', 'pruritus', 'urticaria', 'decubitus_ulcer',
                 'other_skin_and_subcutaneous_diseases', 'glaucoma', 'cataract', 'macular_degeneration',
                 'refraction_and_accommodation_disorders', 'age_related_and_other_hearing_loss', 'other_vision_loss',
                 'other_sense_organ_diseases', 'caries_of_deciduous_teeth', 'caries_of_permanent_teeth',
                 'periodontal_diseases', 'edentulism_and_severe_tooth_loss', 'other_oral_disorders',
                 'sudden_infant_death_syndrome', 'pedestrian_road_injuries', 'cyclist_road_injuries',
                 'motorcyclist_road_injuries', 'motor_vehicle_road_injuries', 'other_road_injuries',
                 'other_transport_injuries', 'falls', 'drowning', 'fire_heat_and_hot_substances', 'poisonings',
                 'unintentional_firearm_injuries', 'unintentional_suffocation',
                 'other_exposure_to_mechanical_forces', 'adverse_effects_of_medical_treatment',
                 'venomous_animal_contact', 'non_venomous_animal_contact',
                 'pulmonary_aspiration_and_foreign_body_in_airway', 'foreign_body_in_eyes',
                 ...
                 'extensively_drug_resistant_tuberculosis', 'drug_susceptible_hiv_aids_tuberculosis',
                 'multidrug_resistant_hiv_aids_tuberculosis_without_extensive_drug_resistance',
                 'extensively_drug_resistant_hiv_aids_tuberculosis', 'latent_tuberculosis_infection', )
    ...
    def __init__(self, **kwargs):
        ...
        self.pneumococcal_meningitis = kwargs.get('pneumococcal_meningitis')
        self.h_influenzae_type_b_meningitis = kwargs.get('h_influenzae_type_b_meningitis')
        self.meningococcal_meningitis = kwargs.get('meningococcal_meningitis')
        self.other_meningitis = kwargs.get('other_meningitis')
        ...
        self.maternal_abortion_miscarriage_and_ectopic_pregnancy = kwargs.get('maternal_abortion_miscarriage_and_ectopic_pregnancy')
        ...
        self.neonatal_preterm_birth_complications = kwargs.get('neonatal_preterm_birth_complications')
        ...
        self.iron_deficiency_anemia = kwargs.get('iron_deficiency_anemia')
        ...
        self.hepatitis_b = kwargs.get('hepatitis_b')
        self.hepatitis_c = kwargs.get('hepatitis_c')
        ...
        self.brain_and_nervous_system_cancer = kwargs.get('brain_and_nervous_system_cancer')
        ...
        self.hemorrhagic_stroke = kwargs.get('hemorrhagic_stroke')
        ...
        self.alzheimer_disease_and_other_dementias = kwargs.get('alzheimer_disease_and_other_dementias')
        self.parkinson_disease = kwargs.get('parkinson_disease')
        self.epilepsy = kwargs.get('epilepsy')
        ...
        self.autism = kwargs.get('autism')
        self.asperger_syndrome_and_other_autistic_spectrum_disorders = kwargs.get('asperger_syndrome_and_other_autistic_spectrum_disorders')
        ...
        self.other_mental_and_substance_use_disorders = kwargs.get('other_mental_and_substance_use_disorders')
        self.diabetes_mellitus = kwargs.get('diabetes_mellitus')
        self.acute_glomerulonephritis = kwargs.get('acute_glomerulonephritis')
        self.chronic_kidney_disease_due_to_diabetes_mellitus = kwargs.get('chronic_kidney_disease_due_to_diabetes_mellitus')
        ...
        self.chronic_kidney_disease_due_to_other_causes = kwargs.get('chronic_kidney_disease_due_to_other_causes')
        self.interstitial_nephritis_and_urinary_tract_infections = kwargs.get('interstitial_nephritis_and_urinary_tract_infections')
        ...
        self.macular_degeneration = kwargs.get('macular_degeneration')
        self.refraction_and_accommodation_disorders = kwargs.get('refraction_and_accommodation_disorders')
        ...
        self.edentulism_and_severe_tooth_loss = kwargs.get('edentulism_and_severe_tooth_loss')
        ...
        self.unintentional_suffocation = kwargs.get('unintentional_suffocation')
        ...
        self.drug_susceptible_hiv_aids_tuberculosis = kwargs.get('drug_susceptible_hiv_aids_tuberculosis')
        self.multidrug_resistant_hiv_aids_tuberculosis_without_extensive_drug_resistance = kwargs.get('multidrug_resistant_hiv_aids_tuberculosis_without_extensive_drug_resistance')
        self.extensively_drug_resistant_hiv_aids_tuberculosis = kwargs.get('extensively_drug_resistant_hiv_aids_tuberculosis')
...
class Sequelae(GbdRecord):
    ...
    __slots__ = ('acute_typhoid_infection', 'severe_typhoid_fever', 'intestinal_perforation_due_to_typhoid',
                 ...
                 'acute_pneumococcal_meningitis', 'mild_behavioral_problems_due_to_pneumococcal_meningitis',
                 'mild_motor_impairment_due_to_long_term_due_to_pneumococcal_meningitis',
                 'mild_motor_plus_cognitive_impairments_due_to_pneumococcal_meningitis',
                 'borderline_intellectual_disability_due_to_pneumococcal_meningitis',
                 'mild_intellectual_disability_due_to_pneumococcal_meningitis',
                 'moderate_motor_impairment_due_to_pneumococcal_meningitis',
                 'severe_motor_impairment_due_to_pneumococcal_meningitis',
                 'moderate_motor_plus_cognitive_impairments_due_to_pneumococcal_meningitis',
                 'severe_motor_plus_cognitive_impairments_due_to_pneumococcal_meningitis',
                 'epilepsy_due_to_pneumococcal_meningitis', 'mild_hearing_loss_due_to_pneumococcal_meningitis',
                 'mild_hearing_loss_with_ringing_due_to_pneumococcal_meningitis',
                 'moderate_hearing_loss_due_to_pneumococcal_meningitis',
                 'moderate_hearing_loss_with_ringing_due_to_pneumococcal_meningitis',
                 'moderately_severe_hearing_loss_due_to_pneumococcal_meningitis',
                 'moderately_severe_hearing_loss_with_ringing_due_to_pneumococcal_meningitis',
                 'severe_hearing_loss_due_to_pneumococcal_meningitis',
                 'severe_hearing_loss_with_ringing_due_to_pneumococcal_meningitis',
                 'profound_hearing_loss_due_to_pneumococcal_meningitis',
                 'profound_hearing_loss_with_ringing_due_to_pneumococcal_meningitis',
                 'complete_hearing_loss_due_to_pneumococcal_meningitis',
                 'complete_hearing_loss_with_ringing_due_to_pneumococcal_meningitis',
                 'acute_h_influenzae_type_b_meningitis',
                 'mild_behavioral_problems_due_to_h_influenzae_type_b_meningitis',
                 'mild_motor_impairment_due_to_long_term_due_to_h_influenzae_type_b_meningitis',
                 'mild_motor_plus_cognitive_impairments_due_to_h_influenzae_type_b_meningitis',
                 'borderline_intellectual_disability_due_to_h_influenzae_type_b_meningitis',
                 'mild_intellectual_disability_due_to_h_influenzae_type_b_meningitis',
                 'moderate_motor_impairment_due_to_h_influenzae_type_b_meningitis',
                 'severe_motor_impairment_due_to_h_influenzae_type_b_meningitis',
                 'moderate_motor_plus_cognitive_impairments_due_to_h_influenzae_type_b_meningitis',
                 'severe_motor_plus_cognitive_impairments_due_to_h_influenzae_type_b_meningitis',
                 'epilepsy_due_to_h_influenzae_type_b_meningitis',
                 'mild_hearing_loss_due_to_h_influenzae_type_b_meningitis',
                 'mild_hearing_loss_with_ringing_due_to_h_influenzae_type_b_meningitis',
                 'moderate_hearing_loss_due_to_h_influenzae_type_b_meningitis',
                 'moderate_hearing_loss_with_ringing_due_to_h_influenzae_type_b_meningitis',
                 'moderately_severe_hearing_loss_due_to_h_influenzae_type_b_meningitis',
                 'moderately_severe_hearing_loss_with_ringing_due_to_h_influenzae_type_b_meningitis',
                 'severe_hearing_loss_due_to_h_influenzae_type_b_meningitis',
                 'severe_hearing_loss_with_ringing_due_to_h_influenzae_type_b_meningitis',
                 'profound_hearing_loss_due_to_h_influenzae_type_b_meningitis',
                 'profound_hearing_loss_with_ringing_due_to_h_influenzae_type_b_meningitis',
                 'complete_hearing_loss_due_to_h_influenzae_type_b_meningitis',
                 'complete_hearing_loss_with_ringing_due_to_h_influenzae_type_b_meningitis',
                 'acute_meningococcal_meningitis', 'mild_behavioral_problems_due_to_meningococcal_meningitis',
                 'mild_motor_impairment_due_to_long_term_due_to_meningococcal_meningitis',
                 'mild_motor_plus_cognitive_impairments_due_to_meningococcal_meningitis',
                 'borderline_intellectual_disability_due_to_meningococcal_meningitis',
                 'mild_intellectual_disability_due_to_meningococcal_meningitis',
                 'moderate_motor_impairment_due_to_meningococcal_meningitis',
                 'severe_motor_impairment_due_to_meningococcal_meningitis',
                 'moderate_motor_plus_cognitive_impairments_due_to_meningococcal_meningitis',
                 'severe_motor_plus_cognitive_impairments_due_to_meningococcal_meningitis',
                 'epilepsy_due_to_meningococcal_meningitis', 'mild_hearing_loss_due_to_meningococcal_meningitis',
                 'mild_hearing_loss_with_ringing_due_to_meningococcal_meningitis',
                 'moderate_hearing_loss_due_to_meningococcal_meningitis',
                 'moderate_hearing_loss_with_ringing_due_to_meningococcal_meningitis',
                 'moderately_severe_hearing_loss_due_to_meningococcal_meningitis',
                 'moderately_severe_hearing_loss_with_ringing_due_to_meningococcal_meningitis',
                 'severe_hearing_loss_due_to_meningococcal_meningitis',
                 'severe_hearing_loss_with_ringing_due_to_meningococcal_meningitis',
                 'profound_hearing_loss_due_to_meningococcal_meningitis',
                 'profound_hearing_loss_with_ringing_due_to_meningococcal_meningitis',
                 'complete_hearing_loss_due_to_meningococcal_meningitis',
                 'complete_hearing_loss_with_ringing_due_to_meningococcal_meningitis',
                 'other_acute_bacterial_meningitis', 'mild_behavioral_problems_due_to_other_bacterial_meningitis',
                 'mild_motor_impairment_due_to_long_term_due_to_other_bacterial_meningitis',
                 'mild_motor_plus_cognitive_impairments_due_to_other_bacterial_meningitis',
                 'borderline_intellectual_disability_due_to_other_bacterial_meningitis',
                 'mild_intellectual_disability_due_to_other_bacterial_meningitis',
                 'moderate_motor_impairment_due_to_other_bacterial_meningitis',
                 'severe_motor_impairment_due_to_other_bacterial_meningitis',
                 'moderate_motor_plus_cognitive_impairments_due_to_other_bacterial_meningitis',
                 'severe_motor_plus_cognitive_impairments_due_to_other_bacterial_meningitis',
                 'epilepsy_due_to_other_meningitis', 'mild_hearing_loss_due_to_other_bacterial_meningitis',
                 'mild_hearing_loss_due_with_ringing_to_other_bacterial_meningitis',
                 'moderate_hearing_loss_due_to_other_bacterial_meningitis',
                 'moderate_hearing_loss_with_ringing_due_to_other_bacterial_meningitis',
                 'moderately_severe_hearing_loss_due_to_other_bacterial_meningitis',
                 'moderately_severe_hearing_loss_with_ringing_due_to_other_bacterial_meningitis',
                 'severe_hearing_loss_due_to_other_bacterial_meningitis',
                 'severe_hearing_loss_with_ringing_due_to_other_bacterial_meningitis',
                 'profound_hearing_loss_due_to_other_bacterial_meningitis',
                 'profound_hearing_loss_with_ringing_due_to_other_bacterial_meningitis',
                 'complete_hearing_loss_due_to_other_bacterial_meningitis',
                 'complete_hearing_loss_with_ringing_due_to_other_bacterial_meningitis', 'acute_viral_meningitis',
                 'acute_encephalitis', 'moderate_diphtheria', 'severe_diphtheria', 'whooping_cough',
                 'severe_tetanus', 'moderate_measles', 'severe_measles', 'chickenpox', 'herpes_zoster',
                 'mild_malaria', 'moderate_malaria', 'severe_malaria', 'acute_chagas_disease',
                 ...
                 'asymptomatic_and_mild_heart_failure_due_to_chagas_disease',
                 'moderate_heart_failure_due_to_chagas_disease', 'severe_heart_failure_due_to_chagas_disease',
                 'moderate_visceral_leishmaniasis', 'severe_visceral_leishmaniasis',
                 'cutaneous_and_mucocutaneous_leishmaniasis', 'mild_schistosomiasis',
                 'mild_diarrhea_due_to_schistosomiasis', 'hematemesis_due_to_schistosomiasis',
                 'hepatomegaly_due_to_schistosomiasis', 'ascites_due_to_schistosomiasis',
                 'dysuria_due_to_schistosomiasis', 'bladder_pathology_due_to_schistosomiasis',
                 'hydronephrosis_due_to_schistosomiasis', 'mild_anemia_due_to_schistosomiasis',
                 'moderate_anemia_due_to_schistosomiasis', 'severe_anemia_due_to_schistosomiasis',
                 'abdominal_problems_due_to_cystic_echinococcosis',
                 ...
                 'asymptomatic_and_mild_heart_failure_due_to_iron_deficiency_anemia',
                 'moderate_heart_failure_due_to_iron_deficiency_anemia',
                 'severe_heart_failure_due_to_iron_deficiency_anemia', 'other_nutritional_deficiencies',
                 'epididymo_orchitis_due_to_chlamydial_infection',
                 ...
                 'terminal_phase_of_brain_and_nervous_system_cancers',
                 ...
                 'diagnosis_and_primary_therapy_phase_of_non_hodgkin_lymphoma',
                 ...
                 'asymptomatic_and_mild_heart_failure_due_to_ischemic_heart_disease',
                 ...
                 'chronic_ischemic_stroke_severity_level_5', 'acute_hemorrhagic_stroke_severity_level_1',
                 'acute_hemorrhagic_stroke_severity_level_2', 'acute_hemorrhagic_stroke_severity_level_4',
                 'acute_hemorrhagic_stroke_severity_level_3', 'acute_hemorrhagic_stroke_severity_level_5',
                 'chronic_hemorrhagic_stroke_severity_level_1', 'chronic_hemorrhagic_stroke_severity_level_2',
                 'chronic_hemorrhagic_stroke_severity_level_4', 'chronic_hemorrhagic_stroke_severity_level_3',
                 'chronic_hemorrhagic_stroke_severity_level_5',
                 'asymptomatic_and_mild_heart_failure_due_to_hypertensive_heart_disease',
                 ...
                 'moderate_endocarditis', 'severe_endocarditis',
                 'asymptomatic_and_mild_heart_failure_due_to_endocarditis',
                 'moderate_heart_failure_due_to_endocarditis', 'severe_heart_failure_due_to_endocarditis',
                 'asymptomatic_and_mild_heart_failure_due_to_other_cardiovascular_diseases',
                 ...
                 'other_chronic_respiratory_diseases', 'mild_anemia_due_to_peptic_ulcer_disease',
                 'moderate_anemia_due_to_peptic_ulcer_disease', 'severe_anemia_due_to_peptic_ulcer_disease',
                 'mild_anemia_due_to_gastritis_and_duodenitis', 'moderate_anemia_due_to_gastritis_and_duodenitis',
                 'severe_anemia_due_to_gastritis_and_duodenitis', 'appendicitis',
                 'paralytic_ileus_and_intestinal_obstruction', 'vascular_intestinal_disorders',
                 'other_digestive_diseases', 'mild_alzheimer_disease_and_other_dementias',
                 'moderate_alzheimer_disease_and_other_dementias', 'severe_alzheimer_disease_and_other_dementias',
                 'mild_parkinson_disease', 'moderate_parkinson_disease', 'severe_parkinson_disease',
                 'seizure_free_treated_epilepsy', 'less_severe_epilepsy', 'severe_epilepsy',
                 'mild_multiple_sclerosis', 'moderate_multiple_sclerosis', 'severe_multiple_sclerosis',
                 'other_neurological_disorders', 'guillain_barre_syndrome_due_to_other_neurological_disorders',
                 'schizophrenia_acute_state', 'schizophrenia_residual_state', 'mild_alcohol_dependence',
                 'moderate_alcohol_dependence', 'severe_alcohol_dependence', 'mild_fetal_alcohol_syndrome',
                 'moderate_fetal_alcohol_syndrome', 'severe_fetal_alcohol_syndrome', 'other_drug_use_disorders',
                 'mild_major_depressive_disorder', 'moderate_major_depressive_disorder',
                 'severe_major_depressive_disorder', 'bipolar_disorder_manic_state',
                 'bipolar_disorder_residual_state', 'mild_anxiety_disorders', 'moderate_anxiety_disorders',
                 'severe_anxiety_disorders', 'anorexia_nervosa', 'bulimia_nervosa',
                 'asperger_syndrome_and_other_autistic_spectrum_disorders',
                 ...
                 'uncomplicated_diabetes_mellitus', 'moderate_vision_impairment_due_to_diabetes_mellitus',
                 'severe_vision_impairment_due_to_diabetes_mellitus', 'blindness_due_to_diabetes_mellitus',
                 'acute_glomerulonephritis', 'end_stage_renal_disease_after_transplant_due_to_diabetes_mellitus',
                 'end_stage_renal_disease_on_dialysis_due_to_diabetes_mellitus',
                 'end_stage_renal_disease_after_transplant_due_to_hypertension',
                 ...
                 'end_stage_renal_disease_on_dialysis_due_to_other_causes',
                 'mild_interstitial_nephritis_and_urinary_tract_infections',
                 'moderate_interstitial_nephritis_and_urinary_tract_infections', 'primary_male_infertility',
                 'secondary_male_infertility', 'other_urinary_diseases',
                 'primary_infertility_due_to_polycystic_ovarian_syndrome', 'idiopathic_primary_female_infertility',
                 'idiopathic_secondary_female_infertility', 'mild_abdominal_pain_due_to_endometriosis',
                 'moderate_abdominal_pain_due_to_endometriosis', 'primary_infertility_due_to_endometriosis',
                 'secondary_infertility_due_to_endometriosis', 'abdominal_pain_due_to_premenstrual_syndrome',
                 'mild_anemia_due_to_other_gynecological_diseases',
                 'moderate_anemia_due_to_other_gynecological_diseases',
                 'severe_anemia_due_to_other_gynecological_diseases',
                 'asymptomatic_and_mild_heart_failure_due_to_thalassemias',
                 'moderate_heart_failure_due_to_thalassemias', 'severe_heart_failure_due_to_thalassemias',
                 ...
                 'asymptomatic_and_mild_heart_failure_due_to_other_hemoglobinopathies_and_hemolytic_anemias',
                 ...
                 'asymptomatic_and_mild_heart_failure_due_to_endocrine_metabolic_blood_and_immune_disorders',
                 ...
                 'near_vision_impairment', 'moderate_vision_impairment_due_to_other_vision_loss',
                 'severe_vision_impairment_due_to_other_vision_loss', 'blindness_due_to_other_vision_loss',
                 'monocular_distance_vision_loss_due_to_pneumococcal_meningitis',
                 'monocular_distance_vision_loss_due_to_h_influenzae_type_b_meningitis',
                 'monocular_distance_vision_loss_due_to_meningococcal_meningitis',
                 'monocular_distance_vision_loss_due_to_other_bacterial_meningitis',
                 ...
                 'cirrhosis_and_other_chronic_liver_diseases_due_to_other_cause_decompensated',
                 ...
                 'blindness_due_to_h_influenzae_type_b_meningitis', 'blindness_due_to_meningococcal_meningitis',
                 'blindness_due_to_other_bacterial_meningitis', 'blindness_due_to_pneumococcal_meningitis',
                 ...
                 'severe_molluscum_contagiosum', 'chronic_hepatitis_b', 'chronic_hepatitis_c',
                 ...
                 'asymptomatic_orofacial_clefts', 'asymptomatic_chronic_obstructive_pulmonary_disease',
                 'asymptomatic_down_syndrome', 'asymptomatic_other_chromosomal_abnormalities',
                 'primary_infertility_due_to_klinefelter_syndrome', 'asymptomatic_klinefelter_syndrome',
                 ...
                 'asymptomatic_chronic_hemorrhagic_stroke', 'asymptomatic_silicosis', 'asymptomatic_asbestosis',
                 'asymptomatic_coal_workers_pneumoconiosis', 'asymptomatic_other_pneumoconiosis',
                 'asymptomatic_interstitial_lung_disease_and_pulmonary_sarcoidosis',
                 'asymptomatic_angina_due_to_ischemic_heart_disease', 'ulcerative_colitis', 'crohns_disease',
                 'asymptomatic_onchocerciasis', 'asymptomatic_ascariasis', 'asymptomatic_trichuriasis',
                 'asymptomatic_clonorchiasis', 'asymptomatic_fascioliasis',
                 'asymptomatic_intestinal_fluke_infection', 'asymptomatic_opisthorchiasis',
                 'asymptomatic_paragonimiasis', 'asymptomatic_peripheral_vascular_disease',
                 'asymptomatic_benign_prostatic_hyperplasia', 'symptomatic_benign_prostatic_hyperplasia',
                 'asymptomatic_uterine_fibroids', 'asymptomatic_other_musculoskeletal_disorders', 'mild_cellulitis',
                 ...
                 'visible_goiter_with_profound_intellectual_disability_and_mild_heart_failure_due_to_iodine_deficiency',
                 'visible_goiter_with_profound_intellectual_disability_and_moderate_heart_failure_due_to_iodine_deficiency',
                 'visible_goiter_with_profound_intellectual_disability_with_severe_heart_failure_due_to_iodine_deficiency',
                 'asymptomatic_and_mild_heart_failure_due_to_severe_chronic_obstructive_pulmonary_disease',
                 ...
                 'asymptomatic_and_mild_heart_failure_due_to_severe_silicosis',
                 'moderate_heart_failure_due_to_severe_silicosis', 'severe_heart_failure_due_to_severe_silicosis',
                 'severe_silicosis_without_heart_failure',
                 'asymptomatic_and_mild_heart_failure_due_to_severe_asbestosis',
                 'moderate_heart_failure_due_to_severe_asbestosis', 'severe_heart_failure_due_to_severe_asbestosis',
                 'severe_asbestosis_without_heart_failure',
                 'asymptomatic_and_mild_heart_failure_due_to_severe_coal_workers_pneumoconiosis',
                 ...
                 'asymptomatic_and_mild_heart_failure_due_to_severe_other_pneumoconiosis',
                 ...
                 'asymptomatic_and_mild_heart_failure_due_to_severe_interstitial_lung_disease_and_pulmonary_sarcoidosis',
                 ...
                 'stage_iii_chronic_kidney_disease_and_mild_anemia_due_to_diabetes_mellitus',
                 'stage_iii_chronic_kidney_disease_and_moderate_anemia_due_to_diabetes_mellitus',
                 'stage_iii_chronic_kidney_disease_and_severe_anemia_due_to_diabetes_mellitus',
                 'stage_iii_chronic_kidney_disease_without_anemia_due_to_diabetes_mellitus',
                 'stage_iii_chronic_kidney_disease_and_mild_anemia_due_to_hypertension',
                 'stage_iii_chronic_kidney_disease_and_moderate_anemia_due_to_hypertension',
                 'stage_iii_chronic_kidney_disease_and_severe_anemia_due_to_hypertension',
                 'stage_iii_chronic_kidney_disease_without_anemia_due_to_hypertension',
                 'stage_iii_chronic_kidney_disease_and_mild_anemia_due_to_glomerulonephritis',
                 ...
                 'diabetic_foot_due_to_neuropathy', 'diabetic_neuropathy',
                 'diabetic_neuropathy_and_amputation_with_treatment',
                 'diabetic_neuropathy_and_amputation_without_treatment',
                 ...
                 'asymptomatic_and_mild_heart_failure_due_to_rheumatic_heart_disease',
                 ...
                 'asymptomatic_and_mild_heart_failure_due_to_g6pd_deficiency',
                 'moderate_heart_failure_due_to_g6pd_deficiency', 'severe_heart_failure_due_to_g6pd_deficiency',
                 'asymptomatic_g6pd_deficiency', 'asymptomatic_gallbladder_and_biliary_diseases',
                 ...
                 'severe_vision_impairment_due_to_h_influenza_type_b_meningitis',
                 'moderate_vision_impairment_due_to_meningococcal_meningitis',
                 'severe_vision_impairment_due_to_meningococcal_meningitis',
                 'moderate_vision_impairment_due_to_other_bacterial_meningitis',
                 'severe_vision_impairment_due_to_other_bacterial_meningitis',
                 ...
                 'asymptomatic_neonatla_preterm_birth_less_than_28wks',
                 ...
                 'autism_without_intellectual_disability', 'autism_with_borderline_intellectual_disability',
                 'autism_with_mild_intellectual_disability', 'autism_with_moderate_intellectual_disability',
                 'autism_with_severe_intellectual_disability', 'autism_with_profound_intellectual_disability',
                 'asymptomatic_acute_sense_organ_diseases', 'mild_acute_sense_organ_diseases',
                 'moderate_acute_sense_organ_diseases', 'asymptomatic_chronic_sense_organ_diseases',
                 'moderate_chronic_sense_organ_diseases', 'severe_chronic_sense_organ_diseases',
                 ...
                 'stage_v_chronic_kidney_disease_untreated_without_anemia_due_to_diabetes_mellitus',
                 'stage_v_chronic_kidney_disease_untreated_and_mild_anemia_due_to_diabetes_mellitus',
                 'stage_v_chronic_kidney_disease_untreated_and_moderate_anemia_due_to_diabetes_mellitus',
                 'stage_v_chronic_kidney_disease_untreated_and_severe_anemia_due_to_diabetes_mellitus',
                 'stage_v_chronic_kidney_disease_untreated_without_anemia_due_to_hypertension',
                 'stage_v_chronic_kidney_disease_untreated_and_mild_anemia_due_to_hypertension',
                 'stage_v_chronic_kidney_disease_untreated_and_moderate_anemia_due_to_hypertension',
                 'stage_v_chronic_kidney_disease_untreated_and_severe_anemia_due_to_hypertension',
                 'stage_v_chronic_kidney_disease_untreated_without_anemia_due_to_glomerulonephritis',
                 ...
                 'stage_iv_chronic_kidney_disease_untreated_without_anemia_due_to_diabetes_mellitus',
                 'stage_iv_chronic_kidney_disease_untreated_and_mild_anemia_due_to_diabetes_mellitus',
                 'stage_iv_chronic_kidney_disease_untreated_and_moderate_anemia_due_to_diabetes_mellitus',
                 'stage_iv_chronic_kidney_disease_untreated_and_severe_anemia_due_to_diabetes_mellitus',
                 ...
                 'stage_iv_chronic_kidney_disease_untreated_and_severe_anemia_due_to_hypertension',
                 'stage_iv_chronic_kidney_disease_untreated_without_anemia_due_to_glomerulonephritis',
                 ...
                 'asymptomatic_zika_infection', 'asymptomatic_and_mild_heart_failure_due_to_myocarditis',
                 'moderate_heart_failure_due_to_myocarditis', 'severe_heart_failure_due_to_myocarditis',
                 'asymptomatic_and_mild_heart_failure_due_to_alcoholic_cardiomyopathy',
                 'moderate_heart_failure_due_to_alcoholic_cardiomyopathy',
                 'severe_heart_failure_due_to_alcoholic_cardiomyopathy',
                 'asymptomatic_and_mild_heart_failure_due_to_other_cardiomyopathy',
                 ...
                 'visible_goiter_with_symptoms_without_intellectual_disability_or_heart_failure',
                 ...
                 'asymptomatic_crohns_disease', 'mild_pancreatitis_episodes', 'moderate_pancreatitis_episodes',
                 'severe_pancreatitis_episodes', 'mild_acne_vulgaris', 'moderate_acne_vulgaris',
                 ...
                 'congenital_heart_disease_boderline_intellectual_disability_and_mild_heart_failure_due_to_single_ventricle_and_single_ventricle_pathway_heart_defects',
                 ...
                 'congenital_heart_disease_boderline_intellectual_disability_and_mild_heart_failure_due_to_severe_congenital_heart_anomalies_excluding_single_ventricle_heart_defects',
                 ...
                 'congenital_heart_disease_boderline_intellectual_disability_and_mild_heart_failure_due_to_critical_malformations_of_great_vessels_congenital_valvular_heart_disease_and_patent_ductus_arteriosus',
                 ...
                 'congenital_heart_disease_boderline_intellectual_disability_and_mild_heart_failure_due_to_ventricular_septal_defect_and_atrial_septal_defect',
                 ...
                 'aids_with_antiretroviral_treatment_with_mild_anemia',
                 'aids_with_antiretroviral_treatment_with_moderate_anemia',
                 'aids_with_antiretroviral_treatment_with_severe_anemia',
                 'aids_with_antiretroviral_treatment_without_anemia',
                 'aids_without_antiretroviral_treatment_with_mild_anemia',
                 'aids_without_antiretroviral_treatment_with_moderate_anemia',
                 'aids_without_antiretroviral_treatment_with_severe_anemia',
                 'aids_without_antiretroviral_treatment_without_anemia',
    ...
    def __init__(self, **kwargs):
        ...
        self.acute_pneumococcal_meningitis = kwargs.get('acute_pneumococcal_meningitis')
        self.mild_behavioral_problems_due_to_pneumococcal_meningitis = kwargs.get('mild_behavioral_problems_due_to_pneumococcal_meningitis')
        self.mild_motor_impairment_due_to_long_term_due_to_pneumococcal_meningitis = kwargs.get('mild_motor_impairment_due_to_long_term_due_to_pneumococcal_meningitis')
        self.mild_motor_plus_cognitive_impairments_due_to_pneumococcal_meningitis = kwargs.get('mild_motor_plus_cognitive_impairments_due_to_pneumococcal_meningitis')
        self.borderline_intellectual_disability_due_to_pneumococcal_meningitis = kwargs.get('borderline_intellectual_disability_due_to_pneumococcal_meningitis')
        self.mild_intellectual_disability_due_to_pneumococcal_meningitis = kwargs.get('mild_intellectual_disability_due_to_pneumococcal_meningitis')
        self.moderate_motor_impairment_due_to_pneumococcal_meningitis = kwargs.get('moderate_motor_impairment_due_to_pneumococcal_meningitis')
        self.severe_motor_impairment_due_to_pneumococcal_meningitis = kwargs.get('severe_motor_impairment_due_to_pneumococcal_meningitis')
        self.moderate_motor_plus_cognitive_impairments_due_to_pneumococcal_meningitis = kwargs.get('moderate_motor_plus_cognitive_impairments_due_to_pneumococcal_meningitis')
        self.severe_motor_plus_cognitive_impairments_due_to_pneumococcal_meningitis = kwargs.get('severe_motor_plus_cognitive_impairments_due_to_pneumococcal_meningitis')
        self.epilepsy_due_to_pneumococcal_meningitis = kwargs.get('epilepsy_due_to_pneumococcal_meningitis')
        self.mild_hearing_loss_due_to_pneumococcal_meningitis = kwargs.get('mild_hearing_loss_due_to_pneumococcal_meningitis')
        self.mild_hearing_loss_with_ringing_due_to_pneumococcal_meningitis = kwargs.get('mild_hearing_loss_with_ringing_due_to_pneumococcal_meningitis')
        self.moderate_hearing_loss_due_to_pneumococcal_meningitis = kwargs.get('moderate_hearing_loss_due_to_pneumococcal_meningitis')
        self.moderate_hearing_loss_with_ringing_due_to_pneumococcal_meningitis = kwargs.get('moderate_hearing_loss_with_ringing_due_to_pneumococcal_meningitis')
        self.moderately_severe_hearing_loss_due_to_pneumococcal_meningitis = kwargs.get('moderately_severe_hearing_loss_due_to_pneumococcal_meningitis')
        self.moderately_severe_hearing_loss_with_ringing_due_to_pneumococcal_meningitis = kwargs.get('moderately_severe_hearing_loss_with_ringing_due_to_pneumococcal_meningitis')
        self.severe_hearing_loss_due_to_pneumococcal_meningitis = kwargs.get('severe_hearing_loss_due_to_pneumococcal_meningitis')
        self.severe_hearing_loss_with_ringing_due_to_pneumococcal_meningitis = kwargs.get('severe_hearing_loss_with_ringing_due_to_pneumococcal_meningitis')
        self.profound_hearing_loss_due_to_pneumococcal_meningitis = kwargs.get('profound_hearing_loss_due_to_pneumococcal_meningitis')
        self.profound_hearing_loss_with_ringing_due_to_pneumococcal_meningitis = kwargs.get('profound_hearing_loss_with_ringing_due_to_pneumococcal_meningitis')
        self.complete_hearing_loss_due_to_pneumococcal_meningitis = kwargs.get('complete_hearing_loss_due_to_pneumococcal_meningitis')
        self.complete_hearing_loss_with_ringing_due_to_pneumococcal_meningitis = kwargs.get('complete_hearing_loss_with_ringing_due_to_pneumococcal_meningitis')
        self.acute_h_influenzae_type_b_meningitis = kwargs.get('acute_h_influenzae_type_b_meningitis')
        self.mild_behavioral_problems_due_to_h_influenzae_type_b_meningitis = kwargs.get('mild_behavioral_problems_due_to_h_influenzae_type_b_meningitis')
        self.mild_motor_impairment_due_to_long_term_due_to_h_influenzae_type_b_meningitis = kwargs.get('mild_motor_impairment_due_to_long_term_due_to_h_influenzae_type_b_meningitis')
        self.mild_motor_plus_cognitive_impairments_due_to_h_influenzae_type_b_meningitis = kwargs.get('mild_motor_plus_cognitive_impairments_due_to_h_influenzae_type_b_meningitis')
        self.borderline_intellectual_disability_due_to_h_influenzae_type_b_meningitis = kwargs.get('borderline_intellectual_disability_due_to_h_influenzae_type_b_meningitis')
        self.mild_intellectual_disability_due_to_h_influenzae_type_b_meningitis = kwargs.get('mild_intellectual_disability_due_to_h_influenzae_type_b_meningitis')
        self.moderate_motor_impairment_due_to_h_influenzae_type_b_meningitis = kwargs.get('moderate_motor_impairment_due_to_h_influenzae_type_b_meningitis')
        self.severe_motor_impairment_due_to_h_influenzae_type_b_meningitis = kwargs.get('severe_motor_impairment_due_to_h_influenzae_type_b_meningitis')
        self.moderate_motor_plus_cognitive_impairments_due_to_h_influenzae_type_b_meningitis = kwargs.get('moderate_motor_plus_cognitive_impairments_due_to_h_influenzae_type_b_meningitis')
        self.severe_motor_plus_cognitive_impairments_due_to_h_influenzae_type_b_meningitis = kwargs.get('severe_motor_plus_cognitive_impairments_due_to_h_influenzae_type_b_meningitis')
        self.epilepsy_due_to_h_influenzae_type_b_meningitis = kwargs.get('epilepsy_due_to_h_influenzae_type_b_meningitis')
        self.mild_hearing_loss_due_to_h_influenzae_type_b_meningitis = kwargs.get('mild_hearing_loss_due_to_h_influenzae_type_b_meningitis')
        self.mild_hearing_loss_with_ringing_due_to_h_influenzae_type_b_meningitis = kwargs.get('mild_hearing_loss_with_ringing_due_to_h_influenzae_type_b_meningitis')
        self.moderate_hearing_loss_due_to_h_influenzae_type_b_meningitis = kwargs.get('moderate_hearing_loss_due_to_h_influenzae_type_b_meningitis')
        self.moderate_hearing_loss_with_ringing_due_to_h_influenzae_type_b_meningitis = kwargs.get('moderate_hearing_loss_with_ringing_due_to_h_influenzae_type_b_meningitis')
        self.moderately_severe_hearing_loss_due_to_h_influenzae_type_b_meningitis = kwargs.get('moderately_severe_hearing_loss_due_to_h_influenzae_type_b_meningitis')
        self.moderately_severe_hearing_loss_with_ringing_due_to_h_influenzae_type_b_meningitis = kwargs.get('moderately_severe_hearing_loss_with_ringing_due_to_h_influenzae_type_b_meningitis')
        self.severe_hearing_loss_due_to_h_influenzae_type_b_meningitis = kwargs.get('severe_hearing_loss_due_to_h_influenzae_type_b_meningitis')
        self.severe_hearing_loss_with_ringing_due_to_h_influenzae_type_b_meningitis = kwargs.get('severe_hearing_loss_with_ringing_due_to_h_influenzae_type_b_meningitis')
        self.profound_hearing_loss_due_to_h_influenzae_type_b_meningitis = kwargs.get('profound_hearing_loss_due_to_h_influenzae_type_b_meningitis')
        self.profound_hearing_loss_with_ringing_due_to_h_influenzae_type_b_meningitis = kwargs.get('profound_hearing_loss_with_ringing_due_to_h_influenzae_type_b_meningitis')
        self.complete_hearing_loss_due_to_h_influenzae_type_b_meningitis = kwargs.get('complete_hearing_loss_due_to_h_influenzae_type_b_meningitis')
        self.complete_hearing_loss_with_ringing_due_to_h_influenzae_type_b_meningitis = kwargs.get('complete_hearing_loss_with_ringing_due_to_h_influenzae_type_b_meningitis')
        self.acute_meningococcal_meningitis = kwargs.get('acute_meningococcal_meningitis')
        self.mild_behavioral_problems_due_to_meningococcal_meningitis = kwargs.get('mild_behavioral_problems_due_to_meningococcal_meningitis')
        self.mild_motor_impairment_due_to_long_term_due_to_meningococcal_meningitis = kwargs.get('mild_motor_impairment_due_to_long_term_due_to_meningococcal_meningitis')
        self.mild_motor_plus_cognitive_impairments_due_to_meningococcal_meningitis = kwargs.get('mild_motor_plus_cognitive_impairments_due_to_meningococcal_meningitis')
        self.borderline_intellectual_disability_due_to_meningococcal_meningitis = kwargs.get('borderline_intellectual_disability_due_to_meningococcal_meningitis')
        self.mild_intellectual_disability_due_to_meningococcal_meningitis = kwargs.get('mild_intellectual_disability_due_to_meningococcal_meningitis')
        self.moderate_motor_impairment_due_to_meningococcal_meningitis = kwargs.get('moderate_motor_impairment_due_to_meningococcal_meningitis')
        self.severe_motor_impairment_due_to_meningococcal_meningitis = kwargs.get('severe_motor_impairment_due_to_meningococcal_meningitis')
        self.moderate_motor_plus_cognitive_impairments_due_to_meningococcal_meningitis = kwargs.get('moderate_motor_plus_cognitive_impairments_due_to_meningococcal_meningitis')
        self.severe_motor_plus_cognitive_impairments_due_to_meningococcal_meningitis = kwargs.get('severe_motor_plus_cognitive_impairments_due_to_meningococcal_meningitis')
        self.epilepsy_due_to_meningococcal_meningitis = kwargs.get('epilepsy_due_to_meningococcal_meningitis')
        self.mild_hearing_loss_due_to_meningococcal_meningitis = kwargs.get('mild_hearing_loss_due_to_meningococcal_meningitis')
        self.mild_hearing_loss_with_ringing_due_to_meningococcal_meningitis = kwargs.get('mild_hearing_loss_with_ringing_due_to_meningococcal_meningitis')
        self.moderate_hearing_loss_due_to_meningococcal_meningitis = kwargs.get('moderate_hearing_loss_due_to_meningococcal_meningitis')
        self.moderate_hearing_loss_with_ringing_due_to_meningococcal_meningitis = kwargs.get('moderate_hearing_loss_with_ringing_due_to_meningococcal_meningitis')
        self.moderately_severe_hearing_loss_due_to_meningococcal_meningitis = kwargs.get('moderately_severe_hearing_loss_due_to_meningococcal_meningitis')
        self.moderately_severe_hearing_loss_with_ringing_due_to_meningococcal_meningitis = kwargs.get('moderately_severe_hearing_loss_with_ringing_due_to_meningococcal_meningitis')
        self.severe_hearing_loss_due_to_meningococcal_meningitis = kwargs.get('severe_hearing_loss_due_to_meningococcal_meningitis')
        self.severe_hearing_loss_with_ringing_due_to_meningococcal_meningitis = kwargs.get('severe_hearing_loss_with_ringing_due_to_meningococcal_meningitis')
        self.profound_hearing_loss_due_to_meningococcal_meningitis = kwargs.get('profound_hearing_loss_due_to_meningococcal_meningitis')
        self.profound_hearing_loss_with_ringing_due_to_meningococcal_meningitis = kwargs.get('profound_hearing_loss_with_ringing_due_to_meningococcal_meningitis')
        self.complete_hearing_loss_due_to_meningococcal_meningitis = kwargs.get('complete_hearing_loss_due_to_meningococcal_meningitis')
        self.complete_hearing_loss_with_ringing_due_to_meningococcal_meningitis = kwargs.get('complete_hearing_loss_with_ringing_due_to_meningococcal_meningitis')
        self.other_acute_bacterial_meningitis = kwargs.get('other_acute_bacterial_meningitis')
        self.mild_behavioral_problems_due_to_other_bacterial_meningitis = kwargs.get('mild_behavioral_problems_due_to_other_bacterial_meningitis')
        self.mild_motor_impairment_due_to_long_term_due_to_other_bacterial_meningitis = kwargs.get('mild_motor_impairment_due_to_long_term_due_to_other_bacterial_meningitis')
        self.mild_motor_plus_cognitive_impairments_due_to_other_bacterial_meningitis = kwargs.get('mild_motor_plus_cognitive_impairments_due_to_other_bacterial_meningitis')
        self.borderline_intellectual_disability_due_to_other_bacterial_meningitis = kwargs.get('borderline_intellectual_disability_due_to_other_bacterial_meningitis')
        self.mild_intellectual_disability_due_to_other_bacterial_meningitis = kwargs.get('mild_intellectual_disability_due_to_other_bacterial_meningitis')
        self.moderate_motor_impairment_due_to_other_bacterial_meningitis = kwargs.get('moderate_motor_impairment_due_to_other_bacterial_meningitis')
        self.severe_motor_impairment_due_to_other_bacterial_meningitis = kwargs.get('severe_motor_impairment_due_to_other_bacterial_meningitis')
        self.moderate_motor_plus_cognitive_impairments_due_to_other_bacterial_meningitis = kwargs.get('moderate_motor_plus_cognitive_impairments_due_to_other_bacterial_meningitis')
        self.severe_motor_plus_cognitive_impairments_due_to_other_bacterial_meningitis = kwargs.get('severe_motor_plus_cognitive_impairments_due_to_other_bacterial_meningitis')
        self.epilepsy_due_to_other_meningitis = kwargs.get('epilepsy_due_to_other_meningitis')
        self.mild_hearing_loss_due_to_other_bacterial_meningitis = kwargs.get('mild_hearing_loss_due_to_other_bacterial_meningitis')
        self.mild_hearing_loss_due_with_ringing_to_other_bacterial_meningitis = kwargs.get('mild_hearing_loss_due_with_ringing_to_other_bacterial_meningitis')
        self.moderate_hearing_loss_due_to_other_bacterial_meningitis = kwargs.get('moderate_hearing_loss_due_to_other_bacterial_meningitis')
        self.moderate_hearing_loss_with_ringing_due_to_other_bacterial_meningitis = kwargs.get('moderate_hearing_loss_with_ringing_due_to_other_bacterial_meningitis')
        self.moderately_severe_hearing_loss_due_to_other_bacterial_meningitis = kwargs.get('moderately_severe_hearing_loss_due_to_other_bacterial_meningitis')
        self.moderately_severe_hearing_loss_with_ringing_due_to_other_bacterial_meningitis = kwargs.get('moderately_severe_hearing_loss_with_ringing_due_to_other_bacterial_meningitis')
        self.severe_hearing_loss_due_to_other_bacterial_meningitis = kwargs.get('severe_hearing_loss_due_to_other_bacterial_meningitis')
        self.severe_hearing_loss_with_ringing_due_to_other_bacterial_meningitis = kwargs.get('severe_hearing_loss_with_ringing_due_to_other_bacterial_meningitis')
        self.profound_hearing_loss_due_to_other_bacterial_meningitis = kwargs.get('profound_hearing_loss_due_to_other_bacterial_meningitis')
        self.profound_hearing_loss_with_ringing_due_to_other_bacterial_meningitis = kwargs.get('profound_hearing_loss_with_ringing_due_to_other_bacterial_meningitis')
        self.complete_hearing_loss_due_to_other_bacterial_meningitis = kwargs.get('complete_hearing_loss_due_to_other_bacterial_meningitis')
        self.complete_hearing_loss_with_ringing_due_to_other_bacterial_meningitis = kwargs.get('complete_hearing_loss_with_ringing_due_to_other_bacterial_meningitis')
        ...
        self.asymptomatic_and_mild_heart_failure_due_to_chagas_disease = kwargs.get('asymptomatic_and_mild_heart_failure_due_to_chagas_disease')
        ...
        self.asymptomatic_and_mild_heart_failure_due_to_iron_deficiency_anemia = kwargs.get('asymptomatic_and_mild_heart_failure_due_to_iron_deficiency_anemia')
        self.moderate_heart_failure_due_to_iron_deficiency_anemia = kwargs.get('moderate_heart_failure_due_to_iron_deficiency_anemia')
        self.severe_heart_failure_due_to_iron_deficiency_anemia = kwargs.get('severe_heart_failure_due_to_iron_deficiency_anemia')
        self.other_nutritional_deficiencies = kwargs.get('other_nutritional_deficiencies')
        ...
        self.terminal_phase_of_brain_and_nervous_system_cancers = kwargs.get('terminal_phase_of_brain_and_nervous_system_cancers')
        ...
        self.diagnosis_and_primary_therapy_phase_of_non_hodgkin_lymphoma = kwargs.get('diagnosis_and_primary_therapy_phase_of_non_hodgkin_lymphoma')
        self.controlled_phase_of_non_hodgkin_lymphoma = kwargs.get('controlled_phase_of_non_hodgkin_lymphoma')
        self.metastatic_phase_of_non_hodgkin_lymphoma = kwargs.get('metastatic_phase_of_non_hodgkin_lymphoma')
        self.terminal_phase_of_non_hodgkin_lymphoma = kwargs.get('terminal_phase_of_non_hodgkin_lymphoma')
        ...
        self.asymptomatic_and_mild_heart_failure_due_to_ischemic_heart_disease = kwargs.get('asymptomatic_and_mild_heart_failure_due_to_ischemic_heart_disease')
        ...
        self.acute_hemorrhagic_stroke_severity_level_1 = kwargs.get('acute_hemorrhagic_stroke_severity_level_1')
        self.acute_hemorrhagic_stroke_severity_level_2 = kwargs.get('acute_hemorrhagic_stroke_severity_level_2')
        self.acute_hemorrhagic_stroke_severity_level_4 = kwargs.get('acute_hemorrhagic_stroke_severity_level_4')
        self.acute_hemorrhagic_stroke_severity_level_3 = kwargs.get('acute_hemorrhagic_stroke_severity_level_3')
        self.acute_hemorrhagic_stroke_severity_level_5 = kwargs.get('acute_hemorrhagic_stroke_severity_level_5')
        self.chronic_hemorrhagic_stroke_severity_level_1 = kwargs.get('chronic_hemorrhagic_stroke_severity_level_1')
        self.chronic_hemorrhagic_stroke_severity_level_2 = kwargs.get('chronic_hemorrhagic_stroke_severity_level_2')
        self.chronic_hemorrhagic_stroke_severity_level_4 = kwargs.get('chronic_hemorrhagic_stroke_severity_level_4')
        self.chronic_hemorrhagic_stroke_severity_level_3 = kwargs.get('chronic_hemorrhagic_stroke_severity_level_3')
        self.chronic_hemorrhagic_stroke_severity_level_5 = kwargs.get('chronic_hemorrhagic_stroke_severity_level_5')
        self.asymptomatic_and_mild_heart_failure_due_to_hypertensive_heart_disease = kwargs.get('asymptomatic_and_mild_heart_failure_due_to_hypertensive_heart_disease')
        ...
        self.asymptomatic_and_mild_heart_failure_due_to_endocarditis = kwargs.get('asymptomatic_and_mild_heart_failure_due_to_endocarditis')
        ...
        self.asymptomatic_and_mild_heart_failure_due_to_other_cardiovascular_diseases = kwargs.get('asymptomatic_and_mild_heart_failure_due_to_other_cardiovascular_diseases')
        ...
        self.other_chronic_respiratory_diseases = kwargs.get('other_chronic_respiratory_diseases')
        self.mild_anemia_due_to_peptic_ulcer_disease = kwargs.get('mild_anemia_due_to_peptic_ulcer_disease')
        self.moderate_anemia_due_to_peptic_ulcer_disease = kwargs.get('moderate_anemia_due_to_peptic_ulcer_disease')
        self.severe_anemia_due_to_peptic_ulcer_disease = kwargs.get('severe_anemia_due_to_peptic_ulcer_disease')
        self.mild_anemia_due_to_gastritis_and_duodenitis = kwargs.get('mild_anemia_due_to_gastritis_and_duodenitis')
        self.moderate_anemia_due_to_gastritis_and_duodenitis = kwargs.get('moderate_anemia_due_to_gastritis_and_duodenitis')
        self.severe_anemia_due_to_gastritis_and_duodenitis = kwargs.get('severe_anemia_due_to_gastritis_and_duodenitis')
        self.appendicitis = kwargs.get('appendicitis')
        self.paralytic_ileus_and_intestinal_obstruction = kwargs.get('paralytic_ileus_and_intestinal_obstruction')
        self.vascular_intestinal_disorders = kwargs.get('vascular_intestinal_disorders')
        self.other_digestive_diseases = kwargs.get('other_digestive_diseases')
        ...
        self.seizure_free_treated_epilepsy = kwargs.get('seizure_free_treated_epilepsy')
        self.less_severe_epilepsy = kwargs.get('less_severe_epilepsy')
        self.severe_epilepsy = kwargs.get('severe_epilepsy')
        ...
        self.uncomplicated_diabetes_mellitus = kwargs.get('uncomplicated_diabetes_mellitus')
        self.moderate_vision_impairment_due_to_diabetes_mellitus = kwargs.get('moderate_vision_impairment_due_to_diabetes_mellitus')
        self.severe_vision_impairment_due_to_diabetes_mellitus = kwargs.get('severe_vision_impairment_due_to_diabetes_mellitus')
        self.blindness_due_to_diabetes_mellitus = kwargs.get('blindness_due_to_diabetes_mellitus')
        self.acute_glomerulonephritis = kwargs.get('acute_glomerulonephritis')
        self.end_stage_renal_disease_after_transplant_due_to_diabetes_mellitus = kwargs.get('end_stage_renal_disease_after_transplant_due_to_diabetes_mellitus')
        self.end_stage_renal_disease_on_dialysis_due_to_diabetes_mellitus = kwargs.get('end_stage_renal_disease_on_dialysis_due_to_diabetes_mellitus')
        ...
        self.mild_interstitial_nephritis_and_urinary_tract_infections = kwargs.get('mild_interstitial_nephritis_and_urinary_tract_infections')
        self.moderate_interstitial_nephritis_and_urinary_tract_infections = kwargs.get('moderate_interstitial_nephritis_and_urinary_tract_infections')
        self.primary_male_infertility = kwargs.get('primary_male_infertility')
        self.secondary_male_infertility = kwargs.get('secondary_male_infertility')
        self.other_urinary_diseases = kwargs.get('other_urinary_diseases')
        ...
        self.mild_anemia_due_to_other_gynecological_diseases = kwargs.get('mild_anemia_due_to_other_gynecological_diseases')
        self.moderate_anemia_due_to_other_gynecological_diseases = kwargs.get('moderate_anemia_due_to_other_gynecological_diseases')
        self.severe_anemia_due_to_other_gynecological_diseases = kwargs.get('severe_anemia_due_to_other_gynecological_diseases')
        self.asymptomatic_and_mild_heart_failure_due_to_thalassemias = kwargs.get('asymptomatic_and_mild_heart_failure_due_to_thalassemias')
        ...
        self.asymptomatic_and_mild_heart_failure_due_to_other_hemoglobinopathies_and_hemolytic_anemias = kwargs.get('asymptomatic_and_mild_heart_failure_due_to_other_hemoglobinopathies_and_hemolytic_anemias')
        ...
        self.asymptomatic_and_mild_heart_failure_due_to_endocrine_metabolic_blood_and_immune_disorders = kwargs.get('asymptomatic_and_mild_heart_failure_due_to_endocrine_metabolic_blood_and_immune_disorders')
        ...
        self.near_vision_impairment = kwargs.get('near_vision_impairment')
        ...
        self.monocular_distance_vision_loss_due_to_pneumococcal_meningitis = kwargs.get('monocular_distance_vision_loss_due_to_pneumococcal_meningitis')
        self.monocular_distance_vision_loss_due_to_h_influenzae_type_b_meningitis = kwargs.get('monocular_distance_vision_loss_due_to_h_influenzae_type_b_meningitis')
        self.monocular_distance_vision_loss_due_to_meningococcal_meningitis = kwargs.get('monocular_distance_vision_loss_due_to_meningococcal_meningitis')
        self.monocular_distance_vision_loss_due_to_other_bacterial_meningitis = kwargs.get('monocular_distance_vision_loss_due_to_other_bacterial_meningitis')
        ...
        self.cirrhosis_and_other_chronic_liver_diseases_due_to_alcohol_decompensated = kwargs.get('cirrhosis_and_other_chronic_liver_diseases_due_to_alcohol_decompensated')
        self.cirrhosis_and_other_chronic_liver_diseases_due_to_hepatitis_b_decompensated = kwargs.get('cirrhosis_and_other_chronic_liver_diseases_due_to_hepatitis_b_decompensated')
        self.cirrhosis_and_other_chronic_liver_diseases_due_to_hepatitis_c_decompensated = kwargs.get('cirrhosis_and_other_chronic_liver_diseases_due_to_hepatitis_c_decompensated')
        self.cirrhosis_and_other_chronic_liver_diseases_due_to_other_cause_decompensated = kwargs.get('cirrhosis_and_other_chronic_liver_diseases_due_to_other_cause_decompensated')
        ...
        self.blindness_due_to_h_influenzae_type_b_meningitis = kwargs.get('blindness_due_to_h_influenzae_type_b_meningitis')
        self.blindness_due_to_meningococcal_meningitis = kwargs.get('blindness_due_to_meningococcal_meningitis')
        self.blindness_due_to_other_bacterial_meningitis = kwargs.get('blindness_due_to_other_bacterial_meningitis')
        self.blindness_due_to_pneumococcal_meningitis = kwargs.get('blindness_due_to_pneumococcal_meningitis')
        ...
        self.chronic_hepatitis_b = kwargs.get('chronic_hepatitis_b')
        self.chronic_hepatitis_c = kwargs.get('chronic_hepatitis_c')
        ...
        self.asymptomatic_orofacial_clefts = kwargs.get('asymptomatic_orofacial_clefts')
        ...
        self.asymptomatic_chronic_hemorrhagic_stroke = kwargs.get('asymptomatic_chronic_hemorrhagic_stroke')
        ...
        self.visible_goiter_with_profound_intellectual_disability_and_mild_heart_failure_due_to_iodine_deficiency = kwargs.get('visible_goiter_with_profound_intellectual_disability_and_mild_heart_failure_due_to_iodine_deficiency')
        self.visible_goiter_with_profound_intellectual_disability_and_moderate_heart_failure_due_to_iodine_deficiency = kwargs.get('visible_goiter_with_profound_intellectual_disability_and_moderate_heart_failure_due_to_iodine_deficiency')
        self.visible_goiter_with_profound_intellectual_disability_with_severe_heart_failure_due_to_iodine_deficiency = kwargs.get('visible_goiter_with_profound_intellectual_disability_with_severe_heart_failure_due_to_iodine_deficiency')
        self.asymptomatic_and_mild_heart_failure_due_to_severe_chronic_obstructive_pulmonary_disease = kwargs.get('asymptomatic_and_mild_heart_failure_due_to_severe_chronic_obstructive_pulmonary_disease')
        ...
        self.asymptomatic_and_mild_heart_failure_due_to_severe_silicosis = kwargs.get('asymptomatic_and_mild_heart_failure_due_to_severe_silicosis')
        ...
        self.asymptomatic_and_mild_heart_failure_due_to_severe_asbestosis = kwargs.get('asymptomatic_and_mild_heart_failure_due_to_severe_asbestosis')
        ...
        self.asymptomatic_and_mild_heart_failure_due_to_severe_coal_workers_pneumoconiosis = kwargs.get('asymptomatic_and_mild_heart_failure_due_to_severe_coal_workers_pneumoconiosis')
        ...
        self.asymptomatic_and_mild_heart_failure_due_to_severe_other_pneumoconiosis = kwargs.get('asymptomatic_and_mild_heart_failure_due_to_severe_other_pneumoconiosis')
        ...
        self.asymptomatic_and_mild_heart_failure_due_to_severe_interstitial_lung_disease_and_pulmonary_sarcoidosis = kwargs.get('asymptomatic_and_mild_heart_failure_due_to_severe_interstitial_lung_disease_and_pulmonary_sarcoidosis')
        ...
        self.stage_iii_chronic_kidney_disease_and_mild_anemia_due_to_diabetes_mellitus = kwargs.get('stage_iii_chronic_kidney_disease_and_mild_anemia_due_to_diabetes_mellitus')
        self.stage_iii_chronic_kidney_disease_and_moderate_anemia_due_to_diabetes_mellitus = kwargs.get('stage_iii_chronic_kidney_disease_and_moderate_anemia_due_to_diabetes_mellitus')
        self.stage_iii_chronic_kidney_disease_and_severe_anemia_due_to_diabetes_mellitus = kwargs.get('stage_iii_chronic_kidney_disease_and_severe_anemia_due_to_diabetes_mellitus')
        self.stage_iii_chronic_kidney_disease_without_anemia_due_to_diabetes_mellitus = kwargs.get('stage_iii_chronic_kidney_disease_without_anemia_due_to_diabetes_mellitus')
        self.stage_iii_chronic_kidney_disease_and_mild_anemia_due_to_hypertension = kwargs.get('stage_iii_chronic_kidney_disease_and_mild_anemia_due_to_hypertension')
        self.stage_iii_chronic_kidney_disease_and_moderate_anemia_due_to_hypertension = kwargs.get('stage_iii_chronic_kidney_disease_and_moderate_anemia_due_to_hypertension')
        self.stage_iii_chronic_kidney_disease_and_severe_anemia_due_to_hypertension = kwargs.get('stage_iii_chronic_kidney_disease_and_severe_anemia_due_to_hypertension')
        self.stage_iii_chronic_kidney_disease_without_anemia_due_to_hypertension = kwargs.get('stage_iii_chronic_kidney_disease_without_anemia_due_to_hypertension')
        self.stage_iii_chronic_kidney_disease_and_mild_anemia_due_to_glomerulonephritis = kwargs.get('stage_iii_chronic_kidney_disease_and_mild_anemia_due_to_glomerulonephritis')
        ...
        self.diabetic_foot_due_to_neuropathy = kwargs.get('diabetic_foot_due_to_neuropathy')
        self.diabetic_neuropathy = kwargs.get('diabetic_neuropathy')
        self.diabetic_neuropathy_and_amputation_with_treatment = kwargs.get('diabetic_neuropathy_and_amputation_with_treatment')
        self.diabetic_neuropathy_and_amputation_without_treatment = kwargs.get('diabetic_neuropathy_and_amputation_without_treatment')
        ...
        self.asymptomatic_and_mild_heart_failure_due_to_rheumatic_heart_disease = kwargs.get('asymptomatic_and_mild_heart_failure_due_to_rheumatic_heart_disease')
        ...
        self.asymptomatic_and_mild_heart_failure_due_to_g6pd_deficiency = kwargs.get('asymptomatic_and_mild_heart_failure_due_to_g6pd_deficiency')
        ...
        self.severe_vision_impairment_due_to_h_influenza_type_b_meningitis = kwargs.get('severe_vision_impairment_due_to_h_influenza_type_b_meningitis')
        self.moderate_vision_impairment_due_to_meningococcal_meningitis = kwargs.get('moderate_vision_impairment_due_to_meningococcal_meningitis')
        self.severe_vision_impairment_due_to_meningococcal_meningitis = kwargs.get('severe_vision_impairment_due_to_meningococcal_meningitis')
        self.moderate_vision_impairment_due_to_other_bacterial_meningitis = kwargs.get('moderate_vision_impairment_due_to_other_bacterial_meningitis')
        self.severe_vision_impairment_due_to_other_bacterial_meningitis = kwargs.get('severe_vision_impairment_due_to_other_bacterial_meningitis')
        ...
        self.asymptomatic_neonatla_preterm_birth_less_than_28wks = kwargs.get('asymptomatic_neonatla_preterm_birth_less_than_28wks')
        ...
        self.autism_without_intellectual_disability = kwargs.get('autism_without_intellectual_disability')
        self.autism_with_borderline_intellectual_disability = kwargs.get('autism_with_borderline_intellectual_disability')
        self.autism_with_mild_intellectual_disability = kwargs.get('autism_with_mild_intellectual_disability')
        self.autism_with_moderate_intellectual_disability = kwargs.get('autism_with_moderate_intellectual_disability')
        self.autism_with_severe_intellectual_disability = kwargs.get('autism_with_severe_intellectual_disability')
        self.autism_with_profound_intellectual_disability = kwargs.get('autism_with_profound_intellectual_disability')
        ...
        self.asymptomatic_chronic_sense_organ_diseases = kwargs.get('asymptomatic_chronic_sense_organ_diseases')
        self.moderate_chronic_sense_organ_diseases = kwargs.get('moderate_chronic_sense_organ_diseases')
        self.severe_chronic_sense_organ_diseases = kwargs.get('severe_chronic_sense_organ_diseases')
        ...
        self.stage_v_chronic_kidney_disease_untreated_without_anemia_due_to_diabetes_mellitus = kwargs.get('stage_v_chronic_kidney_disease_untreated_without_anemia_due_to_diabetes_mellitus')
        self.stage_v_chronic_kidney_disease_untreated_and_mild_anemia_due_to_diabetes_mellitus = kwargs.get('stage_v_chronic_kidney_disease_untreated_and_mild_anemia_due_to_diabetes_mellitus')
        self.stage_v_chronic_kidney_disease_untreated_and_moderate_anemia_due_to_diabetes_mellitus = kwargs.get('stage_v_chronic_kidney_disease_untreated_and_moderate_anemia_due_to_diabetes_mellitus')
        self.stage_v_chronic_kidney_disease_untreated_and_severe_anemia_due_to_diabetes_mellitus = kwargs.get('stage_v_chronic_kidney_disease_untreated_and_severe_anemia_due_to_diabetes_mellitus')
        self.stage_v_chronic_kidney_disease_untreated_without_anemia_due_to_hypertension = kwargs.get('stage_v_chronic_kidney_disease_untreated_without_anemia_due_to_hypertension')
        self.stage_v_chronic_kidney_disease_untreated_and_mild_anemia_due_to_hypertension = kwargs.get('stage_v_chronic_kidney_disease_untreated_and_mild_anemia_due_to_hypertension')
        self.stage_v_chronic_kidney_disease_untreated_and_moderate_anemia_due_to_hypertension = kwargs.get('stage_v_chronic_kidney_disease_untreated_and_moderate_anemia_due_to_hypertension')
        self.stage_v_chronic_kidney_disease_untreated_and_severe_anemia_due_to_hypertension = kwargs.get('stage_v_chronic_kidney_disease_untreated_and_severe_anemia_due_to_hypertension')
        self.stage_v_chronic_kidney_disease_untreated_without_anemia_due_to_glomerulonephritis = kwargs.get('stage_v_chronic_kidney_disease_untreated_without_anemia_due_to_glomerulonephritis')
        ...
        self.stage_iv_chronic_kidney_disease_untreated_without_anemia_due_to_diabetes_mellitus = kwargs.get('stage_iv_chronic_kidney_disease_untreated_without_anemia_due_to_diabetes_mellitus')
        self.stage_iv_chronic_kidney_disease_untreated_and_mild_anemia_due_to_diabetes_mellitus = kwargs.get('stage_iv_chronic_kidney_disease_untreated_and_mild_anemia_due_to_diabetes_mellitus')
        self.stage_iv_chronic_kidney_disease_untreated_and_moderate_anemia_due_to_diabetes_mellitus = kwargs.get('stage_iv_chronic_kidney_disease_untreated_and_moderate_anemia_due_to_diabetes_mellitus')
        self.stage_iv_chronic_kidney_disease_untreated_and_severe_anemia_due_to_diabetes_mellitus = kwargs.get('stage_iv_chronic_kidney_disease_untreated_and_severe_anemia_due_to_diabetes_mellitus')
        ...
        self.stage_iv_chronic_kidney_disease_untreated_and_severe_anemia_due_to_hypertension = kwargs.get('stage_iv_chronic_kidney_disease_untreated_and_severe_anemia_due_to_hypertension')
        self.stage_iv_chronic_kidney_disease_untreated_without_anemia_due_to_glomerulonephritis = kwargs.get('stage_iv_chronic_kidney_disease_untreated_without_anemia_due_to_glomerulonephritis')
        ...
        self.asymptomatic_and_mild_heart_failure_due_to_myocarditis = kwargs.get('asymptomatic_and_mild_heart_failure_due_to_myocarditis')
        ...
        self.asymptomatic_and_mild_heart_failure_due_to_alcoholic_cardiomyopathy = kwargs.get('asymptomatic_and_mild_heart_failure_due_to_alcoholic_cardiomyopathy')
        ...
        self.asymptomatic_and_mild_heart_failure_due_to_other_cardiomyopathy = kwargs.get('asymptomatic_and_mild_heart_failure_due_to_other_cardiomyopathy')
        ...
        self.visible_goiter_with_symptoms_without_intellectual_disability_or_heart_failure = kwargs.get('visible_goiter_with_symptoms_without_intellectual_disability_or_heart_failure')
        ...
        self.mild_pancreatitis_episodes = kwargs.get('mild_pancreatitis_episodes')
        self.moderate_pancreatitis_episodes = kwargs.get('moderate_pancreatitis_episodes')
        self.severe_pancreatitis_episodes = kwargs.get('severe_pancreatitis_episodes')
        ...
        self.congenital_heart_disease_boderline_intellectual_disability_and_mild_heart_failure_due_to_single_ventricle_and_single_ventricle_pathway_heart_defects = kwargs.get('congenital_heart_disease_boderline_intellectual_disability_and_mild_heart_failure_due_to_single_ventricle_and_single_ventricle_pathway_heart_defects')
        ...
        self.congenital_heart_disease_boderline_intellectual_disability_and_mild_heart_failure_due_to_severe_congenital_heart_anomalies_excluding_single_ventricle_heart_defects = kwargs.get('congenital_heart_disease_boderline_intellectual_disability_and_mild_heart_failure_due_to_severe_congenital_heart_anomalies_excluding_single_ventricle_heart_defects')
        ...
        self.congenital_heart_disease_boderline_intellectual_disability_and_mild_heart_failure_due_to_critical_malformations_of_great_vessels_congenital_valvular_heart_disease_and_patent_ductus_arteriosus = kwargs.get('congenital_heart_disease_boderline_intellectual_disability_and_mild_heart_failure_due_to_critical_malformations_of_great_vessels_congenital_valvular_heart_disease_and_patent_ductus_arteriosus')
        ...
        self.congenital_heart_disease_boderline_intellectual_disability_and_mild_heart_failure_due_to_ventricular_septal_defect_and_atrial_septal_defect = kwargs.get('congenital_heart_disease_boderline_intellectual_disability_and_mild_heart_failure_due_to_ventricular_septal_defect_and_atrial_septal_defect')
        ...
        self.aids_with_antiretroviral_treatment_with_mild_anemia = kwargs.get('aids_with_antiretroviral_treatment_with_mild_anemia')
        self.aids_with_antiretroviral_treatment_with_moderate_anemia = kwargs.get('aids_with_antiretroviral_treatment_with_moderate_anemia')
        self.aids_with_antiretroviral_treatment_with_severe_anemia = kwargs.get('aids_with_antiretroviral_treatment_with_severe_anemia')
        self.aids_with_antiretroviral_treatment_without_anemia = kwargs.get('aids_with_antiretroviral_treatment_without_anemia')
        self.aids_without_antiretroviral_treatment_with_mild_anemia = kwargs.get('aids_without_antiretroviral_treatment_with_mild_anemia')
        self.aids_without_antiretroviral_treatment_with_moderate_anemia = kwargs.get('aids_without_antiretroviral_treatment_with_moderate_anemia')
        self.aids_without_antiretroviral_treatment_with_severe_anemia = kwargs.get('aids_without_antiretroviral_treatment_with_severe_anemia')
        self.aids_without_antiretroviral_treatment_without_anemia = kwargs.get('aids_without_antiretroviral_treatment_without_anemia')
