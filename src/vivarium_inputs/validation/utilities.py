...
def get_restriction_ages(start_id: Union[float, None], end_id: Union[float, None]) -> list:
    if start_id is None:
        return []
...
def check_age_group_ids(data: pd.DataFrame, restriction_start: float = None, restriction_end: float = None):
    ...
    restriction_ages = set(get_restriction_ages(restriction_start, restriction_end))
...
def check_age_restrictions(data: pd.DataFrame, age_group_id_start: int, age_group_id_end: int,
    ...
    """
    expected_gbd_age_ids = get_restriction_ages(age_group_id_start, age_group_id_end)
...
def get_restriction_age_boundary(entity: RiskFactor, boundary: str, reverse=False):
